...
Item {
    ...
    readonly property int volumeLevel: sinkNode && sinkNode.audio ? Math.round(sinkNode.audio.volume * 100) : 0
    readonly property var sinkList: Pipewire.nodes.values.filter(n => n && n.audio && n.isSink && !n.isStream)
    readonly property var sourceList: Pipewire.nodes.values.filter(n => n && n.audio && !n.isSink && !n.isStream)
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                root.hasBluetooth = data.trim() === "yes";
            }
        }
    }
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                for (var i = 0; i < wifiNetworks.count; i++)
                    if (wifiNetworks.get(i).ssid === ssid)
                        return;
                if (inUse)
                    root.wifiConnectedName = ssid;
                wifiNetworks.append({
                    ssid: ssid,
                    signal: signal,
                    security: security,
    ...
    Process {
        id: btMonitorProc
        running: true
        command: ["stdbuf", "-oL", "dbus-monitor", "--system", "type='signal',sender='org.bluez'"]
        stdout: SplitParser {
            onRead: data => {
                if (!data)
                    return;
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                Text {
                                    text: !root.wifiEnabled ? "Off" : (root.wifiConnectedName !== "" ? root.wifiConnectedName : "On")
                            ...
                            Column {
                                ...
                                ListView {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        color: sel ? Qt.rgba(Theme.colBlue.r, Theme.colBlue.g, Theme.colBlue.b, 0.18) : (wMouse.containsMouse ? Qt.rgba(1, 1, 1, 0.06) : "transparent")
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                Text {
                                    text: !root.bluetoothEnabled ? "Off" : (root.btConnectedName !== "" ? root.btConnectedName : "On")
                                    color: Theme.colMuted
                                    font.pixelSize: Theme.fontSize - 2
                                    font.family: Theme.fontFamily
                                    width: 180
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                ListView {
                                    ...
                                    Text {
                                        anchors.centerIn: parent
                                        text: btDevices.count === 0 ? (root.bluetoothEnabled ? "No paired devices" : "Bluetooth disabled") : ""
                                        color: Theme.colMuted
                                        font.pixelSize: Theme.fontSize - 2
                                        font.family: Theme.fontFamily
                                        visible: text !== ""
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        height: 32
                                        color: model.connected ? Qt.rgba(Theme.colBlue.r, Theme.colBlue.g, Theme.colBlue.b, 0.18) : (btMouse.containsMouse ? Qt.rgba(1, 1, 1, 0.06) : "transparent")
                            ...
                            Column {
                                ...
                                ListView {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        color: isDefault ? Qt.rgba(Theme.colBlue.r, Theme.colBlue.g, Theme.colBlue.b, 0.18) : (sMouse.containsMouse ? Qt.rgba(1, 1, 1, 0.06) : "transparent")
                                ...
                                ListView {
                                    ...
                                    delegate: Rectangle {
                                        ...
                                        color: isDefault ? Qt.rgba(Theme.colBlue.r, Theme.colBlue.g, Theme.colBlue.b, 0.18) : (srcMouse.containsMouse ? Qt.rgba(1, 1, 1, 0.06) : "transparent")
